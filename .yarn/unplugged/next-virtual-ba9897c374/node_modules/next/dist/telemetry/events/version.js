...
if(typeof "9.0.6-canary.1"!=='string'){return Promise.resolve();}return(0,_storage.record)({eventName:EVENT_VERSION,payload:{nextVersion:"9.0.6-canary.1",nodeVersion:process.version,cliCommand:event.cliCommand}});}