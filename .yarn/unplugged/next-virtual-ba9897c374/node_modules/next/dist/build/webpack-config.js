...
async function getBaseWebpackConfig(
  ...
  const clientEntries = !isServer
    ? {
        ...
        "main.js": [],
        [_constants2.CLIENT_STATIC_FILES_RUNTIME_MAIN]:
          `.${_path.default.sep}` +
          _path.default.relative(
            dir,
            _path.default.join(
              _constants.NEXT_PROJECT_ROOT_DIST_CLIENT,
  ...
  let typeScriptPath;
  try {
    typeScriptPath = (0, _resolveRequest.resolveRequest)(
      "typescript",
      `${dir}/`
    );
  } catch (_) {}
  ...
  const resolveConfig = {
    ...
    alias: {
      ...
      [_constants.PAGES_DIR_ALIAS]: _path.default.join(dir, "pages"),
  ...
  let webpackConfig = {
    ...
    optimization: {
      ...
      minimizer: [
        new _index.TerserPlugin({ ...terserPluginConfig, terserOptions })
      ]
    },
    ...
    output: {
      ...
      filename: ({ chunk }) => {
        ...
        if (
          !dev &&
          (chunk.name === _constants2.CLIENT_STATIC_FILES_RUNTIME_MAIN ||
            chunk.name === _constants2.CLIENT_STATIC_FILES_RUNTIME_WEBPACK)
        ) {
  ...
  if (typeof originalEntry !== "undefined") {
    webpackConfig.entry = async () => {
      ...
      if (clientEntries && entry["main.js"] && entry["main.js"].length > 0) {
        const originalFile =
          clientEntries[_constants2.CLIENT_STATIC_FILES_RUNTIME_MAIN]; // @ts-ignore TODO: investigate type error
        entry[_constants2.CLIENT_STATIC_FILES_RUNTIME_MAIN] = [
          ...entry["main.js"],
          originalFile
        ];
      }
